...
# 2026-09-17 按最新简历同步过一次：简历里份量最重的是电竞赛事直播制作
# （网易实习，REP2/OBS/vMix/AR播控），原来的关键词完全没覆盖这块，
# 补了"直播制作""导播""电竞""赛事直播"；"商业摄影"换成"摄影"，
# 因为她的摄影经历不止商业向（婚礼跟拍、城市人文、微电影摄影指导都有）；
# 另外"调色"是简历里写的具体技能（DaVinci Resolve），之前也没搜过。
MEDIA_KEYWORDS = [
    "新媒体运营", "短视频", "视频剪辑", "摄影", "调色",
    "直播", "直播制作", "导播", "电竞", "赛事直播",
    "内容策划", "文案", "短剧",
]
